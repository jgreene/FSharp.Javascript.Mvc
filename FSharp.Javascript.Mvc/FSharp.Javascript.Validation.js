...
return Microsoft.FSharp.Core.Operators.op_Addition("']")(Microsoft.FSharp.Core.Operators.op_Addition(fieldName)("input[name='"))    }else{
...
return (function(){
    if(Microsoft.FSharp.Core.Operators.op_Equality("")(formValidator.get_Prefix())){
return new FSharp.Javascript.Jquery.jquery(Microsoft.FSharp.Core.Operators.op_Addition(prop)("#"))    }else{
...
return Microsoft.FSharp.Collections.MapModule.TryFind(table)(property)})(errors.get_Value());
    return (function(){
...
return Microsoft.FSharp.Core.Operators.op_Equality(errorMessage)(x)})})(propertyErrors.get_Value())){
return null    }else{
...
return Microsoft.FSharp.Collections.MapModule.Find(table)(property)})(errors.get_Value())    }else{
...
return Microsoft.FSharp.Core.Operators.Ignore(value)})(errorElement.hide())    }else{
return (function(){
...
return Microsoft.FSharp.Core.Operators.op_Addition(acc)(Microsoft.FSharp.Core.Operators.op_Addition("<br/>")(next))}})})(errs.get_Value());
    return Microsoft.FSharp.Core.Operators.op_PipeRight(function(value){
return Microsoft.FSharp.Core.Operators.Ignore(value)})(errorElement.html(errorMessage).show());
})()    };
})();
})()    }else{
return Microsoft.FSharp.Core.Operators.op_PipeRight(function(value){
return Microsoft.FSharp.Core.Operators.Ignore(value)})(errorElement.hide())    };
})();
})()    };
...
return Microsoft.FSharp.Core.Operators.op_Inequality("")(value)    }else{
return false    };
})()){
return error(prop)("Invalid DateTime option")    }else{
...
return error(prop)("Invalid Boolean option")    }else{
return (function(tupledArg){
return (function(){
    var arg00 = tupledArg.Item1;
    var arg01 = tupledArg.Item2;
...
return error(prop)("Invalid Integer option")    }else{
return (function(tupledArg){
return (function(){
    var arg00 = tupledArg.Item1;
    var arg01 = tupledArg.Item2;
...
return (function(){
    ...
    return (function(){
    if(Microsoft.FSharp.Core.FSharpOption.get_IsNone(parsed)){
return error(prop)("Invalid DateTime")    }else{
return null    };
})();
})()    }else{
return (function(){
...
return (function(){
    ...
    return (function(){
    if(Microsoft.FSharp.Core.FSharpOption.get_IsNone(parsed)){
return error(prop)("Invalid Integer")    }else{
return (function(tupledArg){
return (function(){
    var arg00 = tupledArg.Item1;
    var arg01 = tupledArg.Item2;
...
return (function(){
    ...
    return (function(){
    if(Microsoft.FSharp.Core.FSharpOption.get_IsNone(parsed)){
return error(prop)("Invalid Decimal")    }else{
return (function(tupledArg){
return (function(){
    var arg00 = tupledArg.Item1;
    var arg01 = tupledArg.Item2;
...
return (function(){
    ...
    return (function(){
    if(Microsoft.FSharp.Core.FSharpOption.get_IsNone(parsed)){
return error(prop)("Invalid Boolean")    }else{
return (function(tupledArg){
return (function(){
    var arg00 = tupledArg.Item1;
    var arg01 = tupledArg.Item2;
...
return Microsoft.FSharp.Core.Operators.Ignore(value)})(input.fsharpBind(function(unitVar0){
return (function(){
...
return false    };
    ...
    return Microsoft.FSharp.Core.Operators.op_PipeRight(function(value){
return Microsoft.FSharp.Core.Operators.Ignore(value)})(input.blur(function(unitVar0){
return (function(){
    resetErrors(field);
    Microsoft.FSharp.Core.Operators.op_PipeRight(function(value){
return Microsoft.FSharp.Core.Operators.Ignore(value)})(input.triggerHandler("FSharpValidate"));
    return displayErrors(field);
})()}));
})()})})(formValidator.get_Validators());
    return Microsoft.FSharp.Core.Operators.op_PipeRight(function(value){
return Microsoft.FSharp.Core.Operators.Ignore(value)})(form.submit(function(unitVar0){
return (function(){
    Microsoft.FSharp.Core.Operators.op_PipeRight(function(source){
return Microsoft.FSharp.Collections.SeqModule.Iterate(source)(function(validator){
return (function(){
